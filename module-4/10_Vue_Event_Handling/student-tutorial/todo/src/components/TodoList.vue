...
export default {
    ...
    methods: {
        changeStatus(id) {
            //sample code
            //this.todos[id-1].completed = !this.todo
        const arrayIndex = this.todos.findIndex((todo) => todo.id == id);
        this.todos[arrayIndex].completed = !this.todos[arrayIndex].completed;
        }
    }
}
</script>
